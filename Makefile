...
immichframe-status: ## Show ImmichFrame app, Vault sync, route, and endpoint status
	...
	@$(KUBECTL_ADMIN) -n immichframe get secret immichframe -o jsonpath='{range $$k,$$v := .data}{$$k}{"\n"}{end}' 2>/dev/null || true
